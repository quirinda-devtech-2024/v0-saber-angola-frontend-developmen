...
import { BookOpen, Users, Award, Lightbulb, ArrowRight, UserPlus, FileText, GraduationCap } from "lucide-react"
          ...
          <div className="container max-w-4xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground">
                Junte-se aos estudantes que já usam o SaberAngola para criar documentos profissionais
              </p>
            </div>
